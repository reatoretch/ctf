...
# Measure the time until the web page is displayed
GET[3] = URL1
init = time.time()
data = subprocess.check_output(GET)
# Store as a sufficiently large value
check = 2*(time.time() - init)

"""Extract the time display displayed on the website
   with regular expressions and compare
